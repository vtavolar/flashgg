...
#                                       diphotonMVAweightfile = cms.FileInPath("flashgg/Taggers/data/Flashgg_DiPhotonMVA_76x_transfS4R9EW_decorrSsMoMSpectator.weights.xml"),
                                       sigmaMdecorrFile = cms.FileInPath("flashgg/Taggers/data/diphoMVA_sigmaMoMdecorr.root"),
