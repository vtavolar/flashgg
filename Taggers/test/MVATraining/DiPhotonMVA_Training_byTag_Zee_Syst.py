...
#process.flashggPreselectedDiPhotons.cut  = "(%s ) && mass>70. && mass<110." %(process.flashggPreselectedDiPhotons.cut.pythonValue())
if customize.runOnZ != '':
...
if customize.processType != 'data'and customize.runOnZ != 'single':
        process.p = cms.Path(process.flashggDiPhotonSystematics*
                     (process.flashggTagSequence*process.systematicsTagSequences)*
                     process.flashggSystTagMerger*
                     process.tagsDumper)
else:
    process.p = cms.Path(process.hltHighLevel*process.flashggDiPhotonSystematics*
                     (process.flashggTagSequence*process.systematicsTagSequences)*
                     process.flashggSystTagMerger*
                     process.tagsDumper)
